						...
						<tbody>
							<tr class="cart_item">
								...
								<td class="product-thumbnail"><a href="single-product.html"><img
										...
										class="shop_thumbnail" src="resources/img/comingSoon.jpg"></a></td>
							...
							<tr>
								<td class="actions" colspan="6">
									...
									name="update_cart" class="button" id="continue_shopping"> <input type="submit"
									value="Checkout" name="proceed" id="checkout"
